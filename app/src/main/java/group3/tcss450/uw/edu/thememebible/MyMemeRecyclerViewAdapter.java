...
import group3.tcss450.uw.edu.thememebible.MemeFragment.OnListFragmentInteractionListener;
...
public class MyMemeRecyclerViewAdapter extends RecyclerView.Adapter<MyMemeRecyclerViewAdapter.ViewHolder> {
    ...
    public MyMemeRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
